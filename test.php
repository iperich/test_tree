...
<html>
    ...
    <span ng-show="show_add_root">Name: <input name="node_name" ng-model="node_name" ng-keyup="$event.keyCode == 13 && add_node(tree.nodes);"><input type="button" ng-click="add_node(tree.nodes);" value="Add"/></span>
